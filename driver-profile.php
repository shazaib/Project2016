								...
								<div class="container" style="width:400px; margin-top:80px; margin-left:15px;">
								  <table class="table table-hover txt" style="width:400px;">
								    <tbody>
								      ...
								      <input class="form-control"  style="border-color:white; border:0px;"  type="password" name="paswd"  pattern=".{8,}" title="Allow eight or more characters" required contenteditable value="<?php echo $row['password'] ?>"/></td></tr>

								      <tr><th style="font-weight:600;">Phone No :</th><td>
								      <input  class="form-control"  style="border-color:white; border:0px;" type="text" name="phone_no"  pattern="^\d{11}$" title="eg:0000-000-0000" required contenteditable value="<?php echo $row['phone'] ?>"/></td></tr>
