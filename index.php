												...
												<div class="container">
													<div class="row">
														<div class="col-lg-2 col-md-2 col-sm-2">
															<img  class="img-responsive" src="images/img1.png" style="margin: 35px 0px 35px 0px;">
														</div>
														<div class="col-lg-8 col-md-8 col-sm-8">
															<h1>CALL US 24 HOURS</h1>
															<h2>800 666 7777</h2>
														</div>
														<div class="col-lg-2 col-md-2 col-sm-2">
															<img class="img-responsive" style=" margin: 35px 0px 100px 0px;" src="images/img1.png">
														</div>
													</div>
												</div>
											<!-- </div> -->
					...
					<!-- <div class="container">
						<div class="row">
							...
							<div class="col-md-4 col-sm-4">
								...
								<h1 style="font-size:35px; font-weight:600; color:#ffd405; padding:0;" class="price-h1">Rs 25<span style="font-size:20px; color:#000;">/KM</span></h1>
							</div>
							<div class="col-md-4 col-sm-4">
								<img class="img-responsive" src="images/business_class.png">	
								<h1 style="font-size:25px;" class="price-h1">Business Class</h1>
								<h1 style="font-size:35px; font-weight:600; color:#ffd405; padding:0;" class="price-h1">Rs 50<span style="font-size:20px; color:#000;">/KM</span></h1>
							</div>
							<div class="col-md-4 col-sm-4">
