	...
	<div class="side-bar">
		...
		<button class="side-bar-btn btn-img-trip" style="border-bottom:1px solid #ccc; border-top:none;" onclick="location.href='mytrip.php'">My Trip</button>
		
		<button class="side-bar-btn btn-img-payment" style="border-bottom:1px solid #ccc; border-top:none;" onclick="location.href='book-now.php'">Book Now</button>
